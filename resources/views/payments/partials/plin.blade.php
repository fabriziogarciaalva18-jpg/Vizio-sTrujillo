<div class="text-center">
    ...
    <p class="text-muted">1. Abre Plin<br>2. Escanea el código QR<br>3. Ingresa el monto: <strong>S/. {{ number_format($total / 100, 2) }}</strong><br>4. Coloca como referencia: <strong>TU_NOMBRE</strong><br>5. Confirma el pago</p>
</div>